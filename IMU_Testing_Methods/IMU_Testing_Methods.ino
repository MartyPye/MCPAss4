/* IMU Fusion Board - ADXL345 & IMU3000
   ...
   Modified to generate methods for retrieving accelerometer and gyroscope values
*/
...
void loop()
{
    ...
    Serial.print(getAngleX());  // echo the number received to screen
    Serial.print(",");
    Serial.print(getAngleY());  // echo the number received to screen
    Serial.print(",");    
    Serial.print(getAngleZ());  // echo the number received to screen 
    Serial.print(",");     
    Serial.print(getAccX());  // echo the number received to screen
    Serial.print(",");
    Serial.print(getAccY());  // echo the number received to screen
    Serial.print(",");    
    Serial.print(getAccZ());  // echo the number received to screen    

    Serial.println("");     // prints carriage return
    delay(400);             // wait for a second   
}

void bytesToIntegers(){
